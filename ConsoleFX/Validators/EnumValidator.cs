...
{
    public sealed class EnumValidatorAttribute : BaseValidatorAttribute
    {
        private readonly Type _enumType;
        private bool _ignoreCase = false;

        public EnumValidatorAttribute(int parameterIndex, Type enumType)
            : base(parameterIndex)
        {
            _enumType = enumType;
        }
        ...
        public override void Validate(string parameterValue)
        {
            ...
            foreach (string enumName in enumNames)
                if (string.Compare(parameterValue, enumName, _ignoreCase, CultureInfo.InvariantCulture) == 0)
                    return;
            throw new CommandLineException(CommandLineException.Codes.ValidationFailed,
                ...
                parameterValue, string.Join(",", enumNames));
        }
